...
export class CreateTransactions1751700000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`CREATE INDEX "transactions_sender_id_idx" ON "transactions" ("sender_id")`);
    await queryRunner.query(`CREATE INDEX "transactions_receiver_id_idx" ON "transactions" ("receiver_id")`);
    await queryRunner.query(
    ...
    `);
    await queryRunner.query(`CREATE INDEX "idempotency_user_idx" ON "idempotency_keys" ("user_id")`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE "idempotency_keys"`);
    await queryRunner.query(`ALTER TABLE "journals" DROP CONSTRAINT "journals_transaction_fk"`);
